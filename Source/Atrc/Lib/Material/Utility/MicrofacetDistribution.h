...
public:
    ...
    virtual std::optional<SampleWiResult> SampleWi(const Vec3 &wo, const Vec2 &sample) const noexcept = 0;

    virtual Real SampleWiPDF(const Vec3 &wi, const Vec3 &wo) const noexcept = 0;
};
