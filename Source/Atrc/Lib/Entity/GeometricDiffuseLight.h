...
public:
    ...
    Real SampleWiAreaPDF(const Vec3 &pos, const Vec3 &nor, const Vec3 &dst) const noexcept override;

    Real SampleWiNonAreaPDF(const Vec3 &wi, const Vec3 &dst) const noexcept override;
