...
/**
 * @brief compute BSDF sampling part in multiple importance sampled direct illumination
 *
...
/**
 * @brief compute phase function sampling part in multiple importance sampled direct illumination
 *
 * the last 3 parameters are used for receiving the phase function sampling result
 */
Spectrum mis_sample_bsdf(
