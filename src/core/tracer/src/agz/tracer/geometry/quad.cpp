...
public:
    ...
    explicit Quad(CustomedFlag customed_flag = DEFAULT_CUSTOMED_FLAG)
    {
...
quad [Geometry]
    ...
    void initialize(const Config &params, obj::ObjectInitContext &init_ctx) override
    {
        ...
        initialize(a, b, c, d, t_a, t_b, t_c, t_d, local_to_world);
...
Geometry *create_quad(
    ...
    Arena &arena)
{
    auto ret = arena.create<Quad>(customed_flag);
