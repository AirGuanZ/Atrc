...
public:
    ...
    explicit TriangleBVH(CustomedFlag customed_flag = DEFAULT_CUSTOMED_FLAG)
    {
...
Geometry *create_triangle_bvh_noembree(
    ...
    Arena &arena)
{
    auto ret = arena.create<TriangleBVH>(customed_flag);
...
Geometry *create_triangle_bvh(
    ...
    Arena &arena)
{
    return create_triangle_bvh_noembree(filename, local_to_world, customed_flag, arena);
}
