...
public:
    ...
    explicit MirrorVarnish(CustomedFlag customed_flag = DEFAULT_CUSTOMED_FLAG)
    {
...
mirror_varnish [Material]
    ...
    void initialize(const Material *internal, const Texture *eta_in, const Texture *eta_out, const Texture *color)
    {
        internal_ = internal;
        eta_in_ = eta_in;
        eta_out_ = eta_out;
...
Material *create_mirror_varnish(
    ...
    Arena &arena)
{
    auto ret = arena.create<MirrorVarnish>(customed_flag);
