...
public:
    ...
    explicit MTL(CustomedFlag customed_flag = DEFAULT_CUSTOMED_FLAG)
    {
...
mtl [Material]
    ...
    void initialize(const Texture *kd, const Texture *ks, const Texture *ns)
    {
        kd_ = kd;
        ks_ = ks;
        ns_ = ns;
...
Material *create_mtl(
    ...
    Arena &arena)
{
    auto ret = arena.create<MTL>(customed_flag);
