...
namespace renderer
{
    ...
    public:
        ...
        std::shared_ptr<Renderer> create(const ConfigGroup &params, CreatingContext &context) const override
        {
            ...
            ao_params.sampler_prototype = context.create<Sampler>(params.child_group("sampler"));
    ...
    public:
        ...
        std::shared_ptr<Renderer> create(const ConfigGroup &params, CreatingContext &context) const override
        {
            ...
            bdpt_params.sampler_prototype = context.create<Sampler>(params.child_group("sampler"));
    ...
    public:
        ...
        std::shared_ptr<Renderer> create(const ConfigGroup &params, CreatingContext &context) const override
        {
            ...
            const auto sampler       = context.create<Sampler>(params.child_group("sampler"));
