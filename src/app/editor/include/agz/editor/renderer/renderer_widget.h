...
public:
    ...
    virtual std::unique_ptr<Renderer> create_renderer(std::shared_ptr<tracer::Scene> scene, const Vec2i &framebuffer_size) const = 0;
...
public:
    ...
    std::unique_ptr<Renderer> create_renderer(std::shared_ptr<tracer::Scene> scene, const Vec2i &framebuffer_size) const;
