...
SeparableBSSRDF::SeparableBSSRDF(const EntityIntersection &inct, const Coord &geometry_coord, const Coord &shading_coord, real eta) noexcept
    : BSSRDF(inct), geometry_coord_(geometry_coord), shading_coord_(shading_coord), eta_(eta)
{

}

BSSRDFSampleResult SeparableBSSRDF::sample(TransportMode mode, const Sample4 &sam, Arena &arena) const
{
