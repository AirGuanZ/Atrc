...
class ThinLensCamera : public Camera
{
    ...
    void init_from_params(const Params &params)
    {
        ...
        camera_to_world_ = Transform3(Trans4::look_at(
...
public:
    ...
    CameraSampleWiResult sample_wi(
        const Vec3 &ref, const Sample2 &sam) const noexcept override
    {
        ...
        const Vec3 focal_film_pos = lens_pos
